...
const (
	...
	// MemberPhasePending indicates that the state is pending for propagation
...
// IsNotReady returns true when given phase == "" OR "Pending"
func (p MemberPhase) IsNotReady() bool {
...
// GetPhase returns phase if exists
func GetPhase(s string) (MemberPhase, bool) {
	switch v := MemberPhase(s); v {
